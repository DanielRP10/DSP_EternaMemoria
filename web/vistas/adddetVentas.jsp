<%-- 
    Document   : adddetVentas
    Created on : 1 nov 2024, 14:01:27
...
<html>
     <head>
        ...
        <title>Agregar Detalle de Ventas</title>
        <%
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="default-section" class="dashboard-section active">
                            ...
                            <form action="ControladorDetallesVentas">
                                Detalle Venta:<br>
                                <input class="form-control" type="text" name="txtdetalleVenta"><br>
                                ID Venta: <br>
                                <input class="form-control" type="text" name="txtIdV"><br>
                                ID Producto: <br>
                                <input class="form-control" type="text" name="txtIdP"><br>
