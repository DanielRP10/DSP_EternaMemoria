<%-- 
    Document   : reporteContratos
    Created on : 25 nov 2024, 12:09:58
            ...
            <div class="main-content">
                <header class="header">
                    <div class="d-flex justify-content-between w-100">
                        <div>
                            <h5 class="mb-0">Reporte de Contratos</h5>
                        </div>
                        <div>
                ...
                <div class="download-container">
                    ...
                    <a href="../reportes/reportContratos.jsp" class="download-button">
                        Mostrar Reporte
                    </a>
